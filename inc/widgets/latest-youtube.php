...
class pipdig_widget_latest_youtube extends WP_Widget {
  ...
  public function __construct() {
     $widget_ops = array('classname' => 'pipdig_widget_latest_youtube', 'description' => __('Automatically displays your latest YouTube video.', 'pipdig-textdomain') );
     $this->WP_Widget('pipdig_widget_latest_youtube', 'pipdig - ' . __('Latest YouTube', 'pipdig-textdomain'), $widget_ops);
  }
  ...
  function widget($args, $instance) {
    ...
    if (!empty($youtubeuser)) {
		...
		_e('Setup not complete. Please add your YouTube username to the YouTube Widget in the dashboard.', 'pipdig-textdomain');
	}
  ...
  public function form( $instance ) {
	...
	<p><?php _e('Add your YouTube user/channel to the box below to show your latest video. This can be found in your channel\'s URL.', 'pipdig-textdomain'); ?></p>
	<p><?php _e('For example, the red part below:', 'pipdig-textdomain'); ?></p> <p><?php echo esc_url('http://youtube.com/user/'); ?><span style="color:red">inthefrow</span></p>
	
	<p>
		<label for="<?php echo $this->get_field_id('youtubeuser'); ?>"><?php _e('YouTube Channel username:', 'pipdig-textdomain'); ?>
