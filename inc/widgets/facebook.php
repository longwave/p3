...
if ( !class_exists( 'pipdig_widget_facebook' ) ) {
	class pipdig_widget_facebook extends WP_Widget {
	  ...
	  public function __construct() {
		  $widget_ops = array('classname' => 'pipdig_widget_facebook', 'description' => __('Displays a Facebook Like Box.', 'p3-textdomain') );
		  parent::__construct('pipdig_widget_facebook', 'pipdig - ' . __('Facebook Widget', 'p3-textdomain'), $widget_ops);
	  }
	  ...
	  function widget($args, $instance) {
		...
		if (!empty($facebook_url)) {
			...
			_e('Setup not complete. Please add your Facebook Page URL to the Facebook Widget in the dashboard.', 'p3-textdomain');
		}
	  ...
	  public function form( $instance ) {
		...
		<p><?php _e('Add your Facebook page URL to the box below. For example, https://facebook.com/pipdig', 'p3-textdomain'); ?></p>

		<p>
			<label for="<?php echo $this->get_field_id('facebook_url'); ?>"><?php _e('Facebook Page URL:', 'p3-textdomain'); ?></label>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('hide_cover'); ?>"><?php _e('Hide Cover Image', 'p3-textdomain'); ?></label>
		</p>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('show_faces'); ?>"><?php _e('Show Faces', 'p3-textdomain'); ?></label>
		</p>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('show_posts'); ?>"><?php _e('Show Posts', 'p3-textdomain'); ?></label>
		</p>
