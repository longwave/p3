...
class pipdig_widget_facebook extends WP_Widget {
  ...
  public function __construct() {
      $widget_ops = array('classname' => 'pipdig_widget_facebook', 'description' => __('Displays a Facebook Like Box.', 'pipdig-power-pack') );
      $this->WP_Widget('pipdig_widget_facebook', 'pipdig - ' . __('Facebook Widget', 'pipdig-power-pack'), $widget_ops);
  }
  ...
  function widget($args, $instance) {
    ...
    if (!empty($facebook_url)) {
		...
		_e('Setup not complete. Please add your Facebook Page URL to the Facebook Widget in the dashboard.', 'pipdig-power-pack');
	}
  ...
  public function form( $instance ) {
	...
	<p><?php _e('Add your Facebook page URL to the box below. For example, https://facebook.com/pipdig', 'pipdig-power-pack'); ?></p>

	<p>
		<label for="<?php echo $this->get_field_id('facebook_url'); ?>"><?php _e('Facebook Page URL:', 'pipdig-power-pack'); ?></label>
	...
	<p>
		...
		<label for="<?php echo $this->get_field_id('hide_cover'); ?>"><?php _e('Hide Cover Image', 'pipdig-power-pack'); ?></label>
	</p>
	...
	<p>
		...
		<label for="<?php echo $this->get_field_id('show_faces'); ?>"><?php _e('Show Faces', 'pipdig-power-pack'); ?></label>
	</p>
	...
	<p>
		...
		<label for="<?php echo $this->get_field_id('show_posts'); ?>"><?php _e('Show Posts', 'pipdig-power-pack'); ?></label>
	</p>
