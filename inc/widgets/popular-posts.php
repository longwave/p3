...
class pipdig_widget_popular_posts extends WP_Widget {
  ...
  public function __construct() {
      $widget_ops = array('classname' => 'pipdig_widget_popular_posts', 'description' => __('Displays your most popular posts.', 'pipdig-textdomain') );
      $this->WP_Widget('pipdig_widget_popular_posts', 'pipdig - ' . __('Popular Posts', 'pipdig-textdomain'), $widget_ops);
  }
