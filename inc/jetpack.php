...
function p3_jp_styles() {
	?>
	<style>
	.jp-jitm, .jitm-banner, .jp-wpcom-connect__container, .post-type-post .yoast-alert, .post-type-page .yoast-alert, .plugins-php.jetpack-disconnected .jp-connect-full__container {display:none!important}
	</style>
	<?php
}
