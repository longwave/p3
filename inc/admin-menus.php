...
/*
	...
	$api = plugins_api('query_plugins', array('user' => 'pipdighost'));
	//var_dump($api->plugins[0]->download_link);
...
*/
	...
	<p><a href="https://go.pipdig.co/open.php?id=wp101videos" target="_blank" rel="noopener">Click here</a> if you are not automatically redirected within 5 seconds.</p
	<?php
}
