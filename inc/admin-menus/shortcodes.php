...
if (!function_exists('pipdig_shortcodes_options_page')) {
	...
	<div class="wrap">
		...
		<div class="card">
			...
			<p><code>[pipdig_left]This text goes to the left[/pipdig_left]</code></p>
			<p><code>[pipdig_right]...and this text goes to the right[/pipdig_right]</code></p>
			<p>For example:</p>
			<img src="http://pipdigz.co.uk/p3/img/shortcodes/left_right_example.jpg" alt="5 Stars" />
		</div>
