...
jQuery( document ).ready( function() {
    ...
    // Upload / Change Image
    function pipdig_image_upload( button_class ) {
    ...
    pipdig_image_upload( '.pipdig-media-upload' );

    // Remove Image
    function pipdig_image_remove( button_class ) {
    ...
    pipdig_image_remove( '.pipdig-media-remove' );
